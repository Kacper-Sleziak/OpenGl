...
light_ambient_0 = [0.1, 0.1, 0.0, 1.0]
light_diffuse_0 = [0.8, 0.8, 0.0, 1.0]
light_specular_0 = [1.0, 1.0, 1.0, 1.0]
light_position_0 = [0.0, 0.0, 10.0, 1.0]


light_ambient_1 = [0.2, 0.5, 0.0, 1.0]
light_diffuse_1 = [0.6, 0.3, 0.2, 1.0]
light_specular_1 = [1.0, 1.0, 1.0, 1.0]
light_position_1 = [15.0, 24.0, 15, 1.0]
