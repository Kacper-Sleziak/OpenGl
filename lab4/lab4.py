...
def mouse_motion_callback(window, x_pos, y_pos):
    ...
    # Zmiana pozycji kamery w poziomie
...
# def keys_button_callback(window, key, scancode, action, mods):
#     global f1_button_pressed
#     global f2_button_pressed
#
#     # Wcisniecie F1 odpowiada za oddalanie
#     if key == GLFW_KEY_F1 and action == GLFW_PRESS:
#         f1_button_pressed = 1
#     else:
#         f1_button_pressed = 0
#
#     # Wcisniecie F2 odpowiada za przyblizanie
...
def main():
    ...
    #glfwSetKeyCallback(window, keys_button_callback)
    glfwSwapInterval(1)
